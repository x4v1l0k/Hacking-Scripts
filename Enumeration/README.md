...
options:
  ...
  -t DEFAULT_TIMEOUT, --timeout DEFAULT_TIMEOUT      Default timeout for the host recognition.
  -a, --alive                                        Show only alive hosts
  -o OUTPUT, --output OUTPUT                         Save to log file
  -oc OUTPUT_CLEAN, --output-clean OUTPUT_CLEAN      Save to log file only ip addresses
